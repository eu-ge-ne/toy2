...
func TestInsertSplittingNodes(t *testing.T) {
	...
	buf.InsertString(50, " elit, tempor")
	...
	buf.InsertString(56, " sed eiusmod")
...
func TestInsertSplittingNodeWithFixup(t *testing.T) {
	...
	buf.InsertString(0, "11")
	buf.InsertString(2, "22")

	buf.InsertString(2, "3")
	buf.InsertString(3, "3")

	buf.InsertString(4, "4")
	buf.InsertString(5, "4")
