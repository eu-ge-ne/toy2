...
func createTextBufReversed() *TextBuf {
	buf := New()
...
func testDeleteHead(t *testing.T, buf *TextBuf, n int) {
	expected := text
...
func testDeleteTail(t *testing.T, buf *TextBuf, n int) {
	expected := text
...
func testDeleteMiddle(t *testing.T, buf *TextBuf, n int) {
	expected := text
